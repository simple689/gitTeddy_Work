    ...
    public class FileController {
        ...
        public string getPath(PathType pathType) {
            ...
            try {
                switch (pathType) {
                    case PathType.DLL:
                        ApplicationEnvironment applicationEnvironment = PlatformServices.Default.Application; // dll路径
                        path = applicationEnvironment.ApplicationBasePath;
                        break;
                    case PathType.Run:
                        path = Directory.GetCurrentDirectory(); // bat路径
                        break;
                    default:
                        break;
                }
